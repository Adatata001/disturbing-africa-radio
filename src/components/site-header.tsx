    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/85 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <a
            href="#live-player"
            className="hidden items-center gap-2 rounded-md bg-primary px-3.5 py-2 text-xs font-bold uppercase tracking-wider text-primary-foreground transition-transform hover:scale-[1.02] sm:inline-flex"
          >
            Listen Live
          </a>
